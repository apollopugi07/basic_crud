	...
	<div id="wrapper">
		...
		<form action="update.php?id=<?php echo $result['studentid']; ?>" method="post">
			...
			<fieldset>
				...
				<div>
					<label for="department"> Middlename </label>
				...
				<div>
					<label for="department"> Birthplace </label>
					<input type="text" name="birthplsce" id="birthplace" value="<?php echo $result['birthplace']; ?>">
				</div>
